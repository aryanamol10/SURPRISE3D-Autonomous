...
def parse_option():
    ...
    parser.add_argument('--use_raw_video', action='store_true')
    parser.add_argument('--video_raw_root', default=None)
    parser.add_argument('--video_feature_root', default=None)
    parser.add_argument('--video_input_dim', type=int, default=256)
    parser.add_argument('--video_frame_size', type=int, default=224)
